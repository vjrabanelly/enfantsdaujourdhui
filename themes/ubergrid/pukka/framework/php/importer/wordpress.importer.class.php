 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class WP_Pukka_Import extends WP_Importer {
	...
	function WP_Pukka_Import() { /* nothing */ }
	...
	function import_end() {
		...
		//echo '<p>' . __( 'Post and media setup done.', 'pukka' ) . '</p>';
		//echo '<p>' . __( 'Remember to update the passwords and roles of imported users.', 'pukka' ) . '</p>';
